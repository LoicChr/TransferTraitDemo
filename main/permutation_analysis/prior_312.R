#############################################################################################
#                                                                                           #
#     Definition of the prior for the model with permuted trait axes in the order 3,1,2     #
#                                                                                           #
#############################################################################################
...
density = function(par){
  ...
  d5 = dunif(par[5], pi, 3*pi, log =TRUE) #l_phi2
  d6 = dunif(par[6], pi, 3*pi, log =TRUE) #c_phi2  
...
sampler = function(n=1){
  ...
  d5 = runif(n, pi, 3*pi) #l_phi2
  d6 = runif(n, pi, 3*pi) #c_phi2  
...
bounds["l_phi2",] <- bounds["l_phi2",] + pi 
bounds["c_phi2",] <- bounds["c_phi2",] + pi 
